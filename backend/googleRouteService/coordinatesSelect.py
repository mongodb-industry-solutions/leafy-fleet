...
# Limit connections per coordinate
MAX_CONNECTIONS = 15  
...
# Save map
m.save("map.html")
print("Map saved as map.html and CSV saved as random_300_routes.csv")