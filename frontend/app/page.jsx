  ...
  return (
    ...
    <div>
      <SideNavigation />
           ...
           <img src="/overview.png" className={styles.architectureImage} alt="Flow of the demo"></img> 
        ...
        <div className={styles.container}>
                ...
                <Card className={styles.card}>
                    ...
                    <Description className={styles.description}> Learn more about using RAG AI Agents to improve fleet managers with MongoDB. 
                ...
                <Card className={styles.card}>
                    <a className={styles.title} href="https://github.com/mongodb-industry-solutions/leafy-fleet">
                ...
                <Card className={styles.card}>
                    ...
                    <Description className={styles.description}> Explore how MongoDB can be leveraged to create an efficient Fleet Manager Software.
                    </Description>
                    <Link
