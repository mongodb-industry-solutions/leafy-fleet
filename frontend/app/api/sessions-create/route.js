...
export async function POST(request) {
  try {
    ...
    console.log('[API sessions-create] Request body:', JSON.stringify(body, null, 2));
    ...
    console.log('[API sessions-create] Backend response status:', response.status);
    ...
    console.log('[API sessions-create] Backend response data:', JSON.stringify(data, null, 2));
